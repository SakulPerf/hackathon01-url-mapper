...
namespace UrlMapper.Tests
{
    public class BuilderTests
    {
        ...
        [InlineData(null, " ", "", "", false)]
        [InlineData(null, "something", "", "", false)]
        ...
        [InlineData("something", null, "", "", false)]
        ...
        [InlineData("something/{p1}", "nothing/miolynet", "", "", false)]
        ...
        [InlineData("https://hackathon.com", "https://hackathon.com/", "", "", false)]
        [InlineData("https://hackathon.com/", "https://hackathon.com", "", "", false)]
        [InlineData("https://hackathon.com/", "https://hackathon.com/", "", "")]
        [InlineData("https://hackathon.com/none", "https://hackathon.com/none", "", "")]
        [InlineData("https://hackathon.com/none", "https://hackathon.com/none/", "", "", false)]
        [InlineData("https://hackathon.com/none/", "https://hackathon.com/none", "", "", false)]
        [InlineData("https://hackathon.com/none/", "https://hackathon.com/none/", "", "")]
        ...
        [InlineData("https://hackathon.com/{username}", "https://hackathon.com/test*123", "{username}", "test*123")]
        [InlineData("https://hackathon.com/{username}", "https://hackathon.com/test+123", "{username}", "test+123")]
        [InlineData("https://hackathon.com/{username}", "https://hackathon.com/test,123", "{username}", "test,123", true, ",,")]
        [InlineData("https://hackathon.com/{username}", "https://hackathon.com/test-123", "{username}", "test-123")]
        [InlineData("https://hackathon.com/{username}", "https://hackathon.com/test.123", "{username}", "test.123")]
        [InlineData("https://hackathon.com/{username}", "https://hackathon.com/test/123", "{username}", "test/123")]
        [InlineData("https://hackathon.com/{username}", "https://hackathon.com/test:123", "{username}", "test:123")]
        ...
        [InlineData("https://hackathon.com/{user*name}", "https://hackathon.com/test*123", "{user*name}", "test*123")]
        [InlineData("https://hackathon.com/{user+name}", "https://hackathon.com/test+123", "{user+name}", "test+123")]
        [InlineData("https://hackathon.com/{user,name}", "https://hackathon.com/test,123", "{user,name}", "test,123", true, ",,")]
        [InlineData("https://hackathon.com/{user-name}", "https://hackathon.com/test-123", "{user-name}", "test-123")]
        [InlineData("https://hackathon.com/{user.name}", "https://hackathon.com/test.123", "{user.name}", "test.123")]
        [InlineData("https://hackathon.com/{user/name}", "https://hackathon.com/test/123", "{user/name}", "test/123")]
        [InlineData("https://hackathon.com/{user:name}", "https://hackathon.com/test:123", "{user:name}", "test:123")]
        ...
        public void BuilderCanWorkCorrectly(string pattern, string url, string keys, string values, bool expectedMatched = true, string splitter = ",")
        {
